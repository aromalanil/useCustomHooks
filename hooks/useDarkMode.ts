 ...
 */
const getGlobalPreference = (): boolean =>
 ...
 */
const getUserPreferredMode = (): boolean => {
 ...
 */
const useDarkMode = (className: string): [boolean, () => void] => {
  const [isDarkMode, setIsDarkMode] = useState<boolean>(getUserPreferredMode());
